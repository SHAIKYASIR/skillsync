    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 relative overflow-hidden">
      ...
      >
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          />
          <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
            {isLogin ? 'Login' : 'Sign Up'}
          </Button>
        </form>
...
function FloatingInput({ id, type, label, value, onChange }: { id: string; type: string; label: string; value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) {
  return (
