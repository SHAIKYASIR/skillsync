          ...
          <CardContent>
            <div className="space-y-4">
              {collaborationFeed.map((item) => (
                <div key={item.id} className="flex items-center space-x-4 bg-blue-700 bg-opacity-50 p-4 rounded-lg transition-all hover:bg-blue-600">
                      ...
                      <Draggable key={task.id} draggableId={task.id} index={index}>
                        {(provided) => (
                          <div
                            ...
                            className="bg-indigo-700 bg-opacity-50 p-4 rounded-lg transition-all hover:bg-indigo-600"
                          >
